...
export default class Content {
    public content(req: http.IncomingMessage, res: http.ServerResponse): void {
        ...
        const nyertes: Nyertes = new Nyertes("nyertes.txt");
        ...
        // 10. feladat: nyertes.txt (ha nem volt nyertes töröljük a txt-t)
        if (nyertesJátékos && nyertesTipp) {
            res.write("10. feladat: nyertes.txt\n");
            megold.állománybaÍr("nyertes.txt", inputFordulo, nyertesTipp, nyertesJátékos.név);
        } else {
            res.write("10. feladat: A fordulóban nem volt nyertes\n");
            try {
        ...
        // 11. feladat: egyszamjatek.txt kiírása a képernyőre
        const adatok: string = megold.egyszamjatekAdatok;
        res.write("11. feladat: az egyszamjatek.txt tartalma:\n");
        res.write(adatok);

        // 12. feladat: nyertes.txt kiírása a képernyőre
        const nyertes2: string[] = nyertes.adatok;
        res.write("12. feladat: a nyertes.txt tartalma:\n");
        res.write(`Név:${nyertes2[0]}, Forduló:${nyertes2[1]}, Tipp:${nyertes2[2]}\n`);
        // <---- Fejezd be a kódolást
        res.write("https://egyszamjatekts13abb.herokuapp.com/");
